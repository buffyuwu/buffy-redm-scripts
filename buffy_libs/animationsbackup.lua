...
RegisterCommand('crossarms', function(source, args, rawCommand)
    ...
    TaskPlayAnim(PlayerPedId(),'mech_skin@buck@butcher', 'trans_to_stoic_butcher', 1.0, -1.0, 100000, 30, 0, true, 0, 0, 0, 0)
end, false)
...
RegisterCommand('impatient', function()
    local ped = PlayerPedId()
    ClearPedTasks(PlayerPedId())
    TaskStartScenarioInPlace(ped, GetHashKey('WORLD_HUMAN_WAITING_IMPATIENT'), -1, 10, 0, 0, 0)
end)
...
RegisterCommand('takenotes', function()
    local ped = PlayerPedId()
    ClearPedTasks(PlayerPedId())
    TaskStartScenarioInPlace(ped, GetHashKey('WORLD_HUMAN_WRITE_NOTEBOOK'), 1000, 10, 0, 0, 0)
end)
...
RegisterCommand('swingpickaxe', function()
    local ped = PlayerPedId()
    ClearPedTasks(PlayerPedId())
    TaskStartScenarioInPlace(ped, GetHashKey('WORLD_HUMAN_PICKAXE_WALL'), -1, 10, 0, 0, 0)
end)
